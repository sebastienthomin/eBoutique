		...
		<div class="container">
			<div class="row centered">
				<div class="col-lg-8 col-lg-offset-2">
					...
					<p>Accédez à toutes les informations sur le panier et modifiez ou validez</p>
				</div>
			</div>
			<!-- row -->
		</div>
		...
		<div class="row">
			...
			<div class="col-lg-5">
				<c:if test="${!empty produit}">
					...
					<button class="btnDecrIncr" id="plus">+</button>
					<input type="text" id="qtePanier" value="1" />
					<button class="btnDecrIncr" id="minus">-</button>
...
<div class="row">
	...
	<div id="validatePanier">Valider mon panier</div>
...
<div id="template" class="hide">
	...
	<button class="btnDecrIncr btn btn-info btnMoins" data-id="moins">-</button>
	<input type="text" class="qteProduct"/>
	<button class="btnDecrIncr btn btn-info btnPlus" data-id="plus">+</button>
	<button class="btn btn-danger idProduct" id="delete">X</button>
	<div class="prixProduct"></div>
	</div>
	</div>
