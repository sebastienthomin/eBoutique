		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a href="authenticate.jsp">Authentification</a></li>
					<li class="active"><a href="catalogue.jsp">Catalogue des
							produits</a></li>
				...
				<c:forEach items="${products}" var="toto">
					...
					<table border="1">
						...
						<tr>
							<!-- Nouvelle ligne -->
							<td>
								<!-- Nouvelle donnée --> <c:out value="${toto.id}" /> <!-- Ecrire l'id de l'objet toto -->
							</td>
			...
			<div class="row centered">
				...
				<div class="col-lg-4">
					...
					<div class="pricing-option">
						...
						<a href="index.jsp#" class="pricing-signup">Sign up</a>
					</div>
					<!-- /pricing-option -->
					<!-- END PRICING TABLE -->
				</div>
			...
			<div class="row centered">
				<div class="col-lg-8 col-lg-offset-2">
					...
					<p>We believe ideas come from everyone, everywhere. At
						...
						own right. And there are a few principles we believeâ€”and we
						believe everyone should believeâ€”about our design craft. These
