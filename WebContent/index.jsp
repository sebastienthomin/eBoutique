	...
	<div id="headerwrap">
		<div class="container">
			<div class="row centered">
				...
				<h1>Bienvenue sur le site <b>eBoutique</b></h1>
				<h2>Connectez-vous pour accéder aux services</h2>
				</div>
			</div><!-- row -->
		</div><!-- container -->
	</div><!-- headerwrap -->
	...
	<div id="dg">
		<div class="container">
			<div class="row centered">
				...
				<div class="col-lg-4">
					<div class="tilt">
					<a href="#"><img src="styles/img/p01.png" alt=""></a>
					</div>
				</div>

				<div class="col-lg-4">
					<div class="tilt">
					<a href="#"><img src="styles/img/p03.png" alt=""></a>
					</div>
				</div>

				<div class="col-lg-4">
					<div class="tilt">
					<a href="#"><img src="styles/img/p02.png" alt=""></a>
					</div>
				</div>
			</div><!-- row -->
		</div><!-- container -->
	...
	<div class="container wb">
		<div class="row centered">
			...
			<div class="col-lg-10 col-lg-offset-1">
				<img class="img-responsive" src="styles/img/munter.png" alt="">
			</div>
		</div><!-- row -->
	</div><!-- container -->
		...
		<div class="container">
			<div class="row centered">
				...
				<div class="col-lg-2 col-lg-offset-1">
					<img src="styles/img/c01.gif" alt="">
				</div>
				<div class="col-lg-2">
					<img src="styles/img/c02.gif" alt="">
				</div>
				<div class="col-lg-2">
					<img src="styles/img/c03.gif" alt="">
				</div>
				<div class="col-lg-2">
					<img src="styles/img/c04.gif" alt="">
				</div>
				<div class="col-lg-2">
					<img src="styles/img/c05.gif" alt="">
				</div>
			</div><!-- row -->
		</div><!-- container -->
	</div><!-- dg -->
