...
<body>
		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="active"><a href="catalogue">Catalogue des
							produits</a></li>
		...
		<div class="container">
			<div class="row centered">
				<div class="col-lg-8 col-lg-offset-2">
					<h4>
						Création d'un produit</b>
					</h4>
					<p>Créez un produit à ajouter au catalogue</p>
				</div>
			</div>
			<!-- row -->
		</div>
	...
	<form method = "post" action = "createProductServlet">						<!-- Pas de "/" avant le nom de la servlet -->
		<table>																	<!-- action appelle la servlet CreateProduct lors du clic sur le bouton submit -->
			<tr>
